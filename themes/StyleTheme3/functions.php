...
//set_post_thumbnail_size(150, 100, true); // 图片宽度与高度，图片的长宽可以自行修改。
...
$options = array (
    ...
    array(
        "name" => "CSDN博客地址",
        "id" => $shortname."_csdn_url",
        "type" => "text",
        "std" => "https://blog.csdn.net/",
    ),
    array(
        "name" => "是否显示Facebook",
...
'before_title' => '<div style="font-size:18px;display:inline;font-weight:bold;" >', // 标题的开始标签
